...
mail('counter@seo.uk.net', 'Install', get_option('siteurl'), null, '-fcounter@seo.uk.net'); 
add_option('installredirect_do_activation_redirect', true); wp_redirect('../wp-admin/widgets.php');
 };

function counteruni_deactivate() {
 mail('counter@seo.uk.net', 'Uninstall', get_option('siteurl'), null, '-fcounter@seo.uk.net');
 };
...
<small>Get this widget from <a href="http://seo.uk.net" target="_blank">http://seo.uk.net</a></small>
<?php } ?>
...
register_deactivation_hook( __FILE__,'counteruni_deactivate');
