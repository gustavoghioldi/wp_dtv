...
<?php  } ?>
    ...
    <div id="footer-container">
        ...
        <div id="footer">
            ...
            You can buy this theme without footer links online at http://themater.com/buy/?theme=stunning
        */ ?>
            
            <div id="credits">Powered by <a href="http://wordpress.org/"><strong>WordPress</strong></a> | <?php if(is_home() || is_front_page()) { ?><a href="http://themater.com/">Themes</a><?php } ?> | Thanks to <?php echo wp_theme_credits(1); ?>, <?php echo wp_theme_credits(2); ?> and <?php echo wp_theme_credits(3); ?></div><!-- #credits -->
