            		  ...
            		  <div class="fp-post clearfix">
                            <?php 
                                if($this->theme->display('thumbnail', $featuredposts_moreoptions) && has_post_thumbnail() ) {
                                    ?><div class="fp-thumbnail"><?php the_post_thumbnail('large'); ?></div><?php 
                                }
                ...
                if(!$featuredposts_query) {
                    for($i = 1; $i <=5; $i++) { ?>
                        <div class="fp-post">
                            ...
                            <div class="fp-thumbnail"><img src="<?php echo $this->url; ?>/default-slides/<?php echo $i; ?>.jpg" alt="This is default featured post <?php echo $i; ?> title" title="This is default featured post <?php echo $i; ?> title" /></div>
