				...
				'basic' => array(
					...
					'items' => array(
						array(
							...
							'id'   => 'spoilers',
							'code' => caps_su_dir_path( SU_PLUGIN_FILE ) . '/inc/examples/spoilers.example',
							'icon' => 'tasks'
						),
						array(
							'name' => __( 'Tabs, vertical tabs, tab anchors', 'su' ),
							'id'   => 'tabs',
							'code' => caps_su_dir_path( SU_PLUGIN_FILE ) . '/inc/examples/tabs.example',
							'icon' => 'folder'
						),
						array(
							'name' => __( 'Column layouts', 'su' ),
							'id'   => 'columns',
							'code' => caps_su_dir_path( SU_PLUGIN_FILE ) . '/inc/examples/columns.example',
							'icon' => 'th-large'
						),
						array(
							'name' => __( 'Media elements, YouTube, Vimeo, Screenr and self-hosted videos, audio player', 'su' ),
							'id'   => 'media',
							'code' => caps_su_dir_path( SU_PLUGIN_FILE ) . '/inc/examples/media.example',
							'icon' => 'play-circle'
						),
						array(
							'name' => __( 'Unlimited buttons', 'su' ),
							'id'   => 'buttons',
							'code' => caps_su_dir_path( SU_PLUGIN_FILE ) . '/inc/examples/buttons.example',
							'icon' => 'heart'
						),
						array(
							'name' => __( 'Animations', 'su' ),
							'id'   => 'animations',
							'code' => caps_su_dir_path( SU_PLUGIN_FILE ) . '/inc/examples/animations.example',
							'icon' => 'bolt'
						),
					)
				),
				'advanced' => array(
					...
					'items' => array(
						array(
							...
							'id' => 'posts',
							'code' => caps_su_dir_path( SU_PLUGIN_FILE ) . '/inc/examples/posts.example',
							'icon' => 'list'
						),
						array(
							'name' => __( 'Nested shortcodes, shortcodes inside of attributes', 'su' ),
							'id' => 'nested',
							'code' => caps_su_dir_path( SU_PLUGIN_FILE ) . '/inc/examples/nested.example',
							'icon' => 'indent'
						),
					)
				),
				...
				'posts' => array(
					...
					'atts' => array(
						'template' => array(
							...
							'desc' => __( '<b>Do not change this field value if you do not understand description below.</b><br/>Relative path to the template file. Default templates is placed under the plugin directory (templates folder). You can copy it under your theme directory and modify as you want. You can use following default templates that already available in the plugin directory:<br/><b%value>templates/default-loop.php</b> -posts loop with large thumbs and small thumbs. <b>You can manage column using this loop</b><br/><b%value>templates/ajax-load-more.php</b> - Ajax loading post <font style="color:red">You can use this loop only one time in a page. Layout depends on your blog archive format</font><br/><b%value>templates/single-post.php</b> - single post template<br/><b%value>templates/list-loop.php</b> - unordered list with posts titles, excerpt and large image thumb. <br/><b%value>templates/slider-loop.php</b> - posts with Large thumb and titles', 'su' )
						),
						'id' => array(
							'default' => '',
						...
						'boxtype' => array(
							'type' => 'bool',
							'default' => 'no',
							'name' => __( 'Image only', 'su' ),
							'desc' => __( 'Select Yes to Only image with title', 'su' )
						),
						'largebox' => array(
							'type' => 'slider',
							'min' => 0,
							...
							'step' => 1,
							'default' => 2,
							'name' => __( 'Large box posts show', 'su' ),
							'desc' => __( 'Specify number of posts that you want to show as a large box. Enter 1 to get 1 large box post posts', 'su' )
						),
						'largeboxcolumn' => array(
							'type' => 'number',
							'min' => 1,
							'max' => 4,
							'step' => 1,
							'default' => 2,
							'name' => __( 'Large box post column', 'su' ),
							'desc' => __( 'Specify number of posts largebox column', 'su' )
						),
						'largeboxcategory' => array(
							'type' => 'bool',
							'default' => 'no',
							'name' => __( 'Display category in Large box post', 'su' ),
							'desc' => __( 'Select Yes to Only image with title', 'su' )
						),
						'largeboxicon' => array(
							'type' => 'bool',
							'default' => 'yes',
							'name' => __( 'Display Post format icon in Large box post', 'su' ),
							'desc' => __( 'Select no to hide post format icon', 'su' )
						),
						'excerptlength' => array(
							'type' => 'slider',
							'min' => 0,
							...
							'step' => 1,
							'default' => 20,
							'name' => __( 'Large box Excerpt lenth', 'su' ),
							'desc' => __( 'How many items (paragraphs or words) to generate. Minimum words amount is 20', 'su' )
						),
						'smallboxcolumn' => array(
							'type' => 'number',
							'min' => 1,
							'max' => 4,
							'step' => 1,
							'default' => 2,
							'name' => __( 'Small box column', 'su' ),
							'desc' => __( 'Specify number of posts small box column( only applicable for templates/default-loop.php)', 'su' )
						),
						'smallboxtype' => array(
							'type' => 'select',
							'values' => array(
								'thumb' => __( 'Show thumbnail', 'su' ),
								'nothumb' => __( 'Hide thumbnail', 'su' )								
							),
							'default' => 'thumb',
							'name' => __( 'Small box type', 'su' ),
							'desc' => __( '( only applicable for templates/default-loop.php)', 'su' )
						),
						'smallboxcomment' => array(
							'type' => 'bool',
							'default' => 'no',
							'name' => __( 'Small box post info display', 'su' ),
							'desc' => __( 'Select Yes to show post info in small box( only applicable for templates/default-loop.php)', 'su' )
						),
						'smallboxbg' => array(
							'type' => 'bool',
							'default' => 'yes',
							'name' => __( 'Small box background', 'su' ),
							'desc' => __( 'Select no to hide background in small box( only applicable for templates/default-loop.php)', 'su' )
						),
						'smallboxexcerpt' => array(
							'type' => 'bool',
							'default' => 'no',
							'name' => __( 'Show excerpt in small box', 'su' ),
							'desc' => __( 'Select Yes to show excerpt in small box( only applicable for templates/default-loop.php)', 'su' )
						),
					),
