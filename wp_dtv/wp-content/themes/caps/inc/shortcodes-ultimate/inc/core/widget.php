...
class Su_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			...
			'description' => __( 'Special Caps Shortcodes Generator widget', 'su' )
		);
		$control_ops = array(
			'width'   => 300,
			'height'  => 350,
		...
		$this->WP_Widget( 'shortcodes-ultimate', __( 'Caps Shortcodes Generator', 'su' ), $widget_ops, $control_ops );
	}
